...
Loading open Street map data, creating a new bbox for while using the osm package to access open street map data.
...
In this section I used open street maps to 
