...
# =============================================================================
# FIGURE 3: Socio-economic Variables (Two-panel: Renters and Median Income)
# =============================================================================
```{r figure-3-data}
...
# Join median income to census tracts
...
```
```{r figure-3a-renter}
# ---- Figure 3a: Percentage of Renters ----
tmap_mode("plot")
...
# Save Figure 3a
png(file.path(ddir, "figure_3a_renter_map.png"), width = 10, height = 8, units = "in", res = 300)
grid.newpage()
...
```
```{r figure-3b-income}
# ---- Figure 3b: Median Household Income ----
tmap_mode("plot")
...
main_income <- tm_shape(Median_income_sf, bbox = mainland_bbox) +
  ...
  tm_title("Median Household Income in Los Angeles County", fontface = "bold", size = 1.2) +
  tm_compass(type = "arrow", position = c("right", "top"), size = 1.5) +
  tm_scalebar(position = c("left", "bottom"), width = 15) +
  tm_layout(frame = TRUE)
...
# Save Figure 3b
png(file.path(ddir, "figure_3b_income_map.png"), width = 10, height = 8, units = "in", res = 300)
grid.newpage()
print(main_income, vp = viewport(x = 0.5, y = 0.5, width = 1, height = 1))
print(inset_income, vp = viewport(x = 0.815, y = 0.1325, width = 0.22, height = 0.28))
dev.off()
```