...
# Increase sigma for smoother output (adjust value as needed)
...
# Create ppp with price as marks
listings_ppp <- ppp(
  x = coords[, 1],
  y = coords[, 2],
...
# IDW interpolation using Smooth.ppp
# sigma controls smoothing, inverse.weights gives IDW behaviour
price_idw <- Smooth.ppp(listings_ppp, sigma = 2)
